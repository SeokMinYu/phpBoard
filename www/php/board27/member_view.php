<?php
	...
	$sql = mysqli_query($connect,"select * from member27 where seqno = '".$seqno."'");
...
<body>
	...
	<input type="hidden" name="seqno" value="<?=$member['seqno'] ?>"/>
		<table align="center">
			...
			<tr>
				<td>생년월일</td>
				<td><input type="text" title="생년월일" name="birthNum" maxlength="6" onkeydown="return onlyNumber(event);" onkeyup='removeChar(event);' onchange='removeChar(event)' value="<?=$member['memberBrith']?>"> ex) 960101</td>
			</tr>
			<tr>
				<td>
				지역
			...
			<tr>
				...
				<td class="email_form">
					<input type="text" title="이메일" name="Email" maxlength="275" value="<?=$email[0]?>"><span>@</span><input type="text" title="이메일" name="Email_sub" id="Email_sub" maxlength="275" value="<?=$email[1]?>"> <select class="sel_email" onchange="email_sub(this.value);">
