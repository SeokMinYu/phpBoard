...
<body>
	...
	<table align="center" border="1px">
		...
		<?php
			...
			$sql = mysqli_query($connect,"select * from member27 where 1=1");
			...
			$sql2 = mysqli_query($connect,"select * from member27 where 1=1 ".$sql_1." ".$sql_2." ".$sql_3." order by seqno desc limit $start_num, $list");
