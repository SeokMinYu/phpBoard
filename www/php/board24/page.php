<?php //페이징
	...
	{ //만약 page가 1보다 작거나 같다면
		...
		echo "<a href='?kind=$search&search_r=$search_r&area=$area&gender=$gender&page=1'><B>처음  <B></a>"; //아니라면 처음글자에 1번페이지로 갈 수있게 링크
	}
	...
	{
		echo "<a href='?kind=$search&search_r=$search_r&area=$area&gender=$gender&page=$total_page'><B>  마지막<B></a>"; //아니라면 마지막글자에 total_page를 링크한다.
	}
?>