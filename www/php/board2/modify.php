                ...
                <form name="writeForm" method="post" enctype="multipart/form-data" onsubmit="return writeChk();" action="modify_ok.php?idx=<?=$bno ?>">
					...
					<div>
						<table border="1px">
							...
							<?php
								...
								?>
						<?/*	<tr>
								<td><input type="text" name="school2[]" value="<?=$arr["school2"][0] ?>"/></td>
								<td><input type="text" name="school2[]" value="<?=$arr["school2"][1] ?>"/></td>
								<td><input type="text" name="school2[]" value="<?=$arr["school2"][2] ?>"/></td>
								<td><input type="text" name="school2[]" value="<?=$arr["school2"][3] ?>"/></td>
							</tr>
							<tr>
								<td><input type="text" name="school3[]" value="<?=$arr["school3"][0] ?>"/></td>
								<td><input type="text" name="school3[]" value="<?=$arr["school3"][1] ?>"/></td>
								<td><input type="text" name="school3[]" value="<?=$arr["school3"][2] ?>"/></td>
								<td><input type="text" name="school3[]" value="<?=$arr["school3"][3] ?>"/></td>
							</tr>
							<tr>
								<td><input type="text" name="school4[]" value="<?=$arr["school4"][0] ?>"/></td>
								<td><input type="text" name="school4[]" value="<?=$arr["school4"][1] ?>"/></td>
								<td><input type="text" name="school4[]" value="<?=$arr["school4"][2] ?>"/></td>
								<td><input type="text" name="school4[]" value="<?=$arr["school4"][3] ?>"/></td>
							</tr>
							*/?>
					...
					<script type="text/javascript">
						...
						nhn.husky.EZCreator.createInIFrame({
							oAppRef: oEditors, elPlaceHolder: "ucontent", sSkinURI: "../board/smarteditor2-archive/SmartEditor2Skin.html",
