<?php
	...
	$rpsql = mysqli_query($connect,"select * from board12 where idx='".$bno."'");
	...
	if ($responseKeys["success"]) 
	{
		...
		$sql=mysqli_query($connect,"insert into board12 (parentsidx,name,userId,title,content,starttime,selectBox,checkBox,radioBtn,serialtable,depth,listorder) values('".$bno."','".$userName."','".$_SESSION['user_id']."','".$title."','".$content."',now(),'".$selectBox."','".$checkBox."','".$gender."','".$seri."','".$depth."','".$listorder."')");
