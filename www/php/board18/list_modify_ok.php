<?php
	...
	$sql = mysqli_query($connect,"update board18 set title='".$title."',content='".$content."' ,modifytime=now(), selectBox='".$selectBox."',checkBox='".$checkBox."',radioBtn='".$gender."' where idx='".$bno."'");
