<?php
	...
	$sql = mysqli_query($connect,"update board14 set title='".$title."',content='".$content."' ,modifytime=now(), selectBox='".$selectBox."',checkBox='".$checkBox."',radioBtn='".$gender."',serialtable='".$seri."' where idx='".$bno."'");
