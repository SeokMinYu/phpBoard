<?php
	...
	$sql = mysqli_query($connect,"select * from member28 where seqno = '".$_SESSION['seq']."'");
...
<body>
	<form name="join" method="post" action="member_update_ok.php" onsvbmit="return joinChk();">
		...
		<table align="center">
			...
			<tr>
				...
				<select name="Phone1">
						...
						<option value="028" <?php if(in_Array("028",$phone)) {?>selected<?}?>>019</option>
