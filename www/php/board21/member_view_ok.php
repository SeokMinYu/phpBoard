<?php	
	...
	$sql = mysqli_query($connect,"update member21 set level='".$level."',memberName='".$name."',modifytime=now(),userBrith='".$userBirth."',userArea='".$userArea."',userSex='".$userSex."',userColor='".$userColor."',userPhone='".$userPhone."',userEmail='".$userEmail."' where seqno='".$seq."'");	
