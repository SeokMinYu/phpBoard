	...
	<div id="register_form" class="form_01">   
	    ...
	    <div class="tbl_frm01 tbl_wrap register_form_inner">
	        ...
	        <ul>
				...
				<li>
	                <label for="reg_mb_area">지역<strong class="sound_only">필수</strong>
	                ...
	                <input type="text" name="mb_area" value="<?php echo isset($member['mb_area'])?$member['mb_area']:''; ?>" id="reg_mb_area" required class="frm_input required nospace full_input" size="70" maxlength="100" placeholder="지역">
