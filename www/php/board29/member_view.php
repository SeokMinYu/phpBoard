<?php
	...
	$sql = mysqli_query($connect,"select * from member29 where seqno = '".$seqno."'");
	...
	<input type="hidden" name="seqno" value="<?=$member['seqno'] ?>"/>
		<table align="center">
			...
			<tr>
				...
				<td class="email_form">
					<input type="text" title="이메일" name="Email" maxlength="295" value="<?=$email[0]?>"><span>@</span><input type="text" title="이메일" name="Email_sub" id="Email_sub" maxlength="295" value="<?=$email[1]?>"> <select class="sel_email" onchange="email_sub(this.value);">
