<?php	
	...
	$sql = mysqli_query($connect,"update member29 set memberName='".$name."',level='".$level."',modifytime=now(),memberBirth='".$userBirth."',memberArea='".$userArea."',memberSex='".$userSex."',memberColor='".$userColor."',memberPhone='".$userPhone."',memberEmail='".$userEmail."' where seqno='".$seq."'");	
