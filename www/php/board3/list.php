	...
	<table align="center" border="1px">
		...
		<?php
			...
			*/
			...
			$sql = mysqli_query($db,"select * from board2 where 1=1 ".$sql_1." ");
			...
			$sql2 = mysqli_query($db,"select * from board2 board2 where 1=1 ".$sql_1." order by listorder desc, parentsidx desc, idx desc, depth asc limit $start_num, $list");
