<?php
	...
	$board = mysqli_fetch_array($sql);
		...
		if($uspwhash == $board['pw']){
			...
			$sql = mysqli_query($connect,"update board2 set title='".$title."',content='".$content."' ,modifytime='".$date."',selectBox='".$selectBox."',checkBox='".$checkBox."',radioBtn='".$gender."',serialtable='".$seri."' where idx='".$bno."'");
