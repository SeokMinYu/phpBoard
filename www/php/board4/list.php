...
<body>
	...
	<table align="center" border="1px">
		...
		<?php
			...
			$sql2 = mysqli_query($connect,"select * from board2 board2 where 1=1 ".$sql_1." order by listorder desc, parentsidx desc, depth asc, idx desc limit $start_num, $list");
            ...
            while($board = mysqli_fetch_array($sql2))
				{
					...
					if(strlen($title)>26) //글자수 20자 이상이면
					{ 
					...
					$mydate = substr($mydate, 0, 10); //날짜 형식
