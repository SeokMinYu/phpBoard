<?php
	...
	if ($responseKeys["success"]) 
	{
		...
		$sql=mysqli_query($connect,"insert into board2 (name,userId,title,content,starttime,modifytime,selectBox,checkBox,radioBtn,serialtable,depth) values('".$userName."','".$_SESSION['user_id']."','".$title."','".$content."','".$date."','".$date."','".$selectBox."','".$checkBox."','".$gender."','".$seri."','".$depth."')");
