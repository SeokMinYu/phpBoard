...
<?php
	...
	if ($responseKeys["success"]) 
	{
		if($idx == "")
		{
			...
			$sql=mysqli_query($connect,"insert into board30 (name,userId,title,content,starttime,notice,depth,boardPw) values('".$userName."','".$_SESSION['user_id']."','".$title."','".$content."',now(),'".$notice."','".$depth."','".$boardPw."')");
		...
		else
		{
			...
			$sql=mysqli_query($connect,"insert into board30 (parentsidx,name,userId,title,content,starttime,depth,listorder) values('".$rep['parentsidx']."','".$userName."','".$_SESSION['user_id']."','".$title."','".$content."',now(),'".$depth."','".$listorder."')");
