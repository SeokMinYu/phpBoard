	...
	<form name="join" method="post" action="member_join_ok.php" onsubmit="return joinChk();">
		<table align="center">
			...
			<tr>
				...
				<td class="email_form">
					<input type="text" title="이메일" name="Email" maxlength="305"><span>@</span><input type="text" title="이메일" name="Email_sub" id="Email_sub" maxlength="305"> <select class="sel_email" onchange="email_sub(this.value);">
