<?php	
	...
	$sql = mysqli_query($connect,"update member25 set memberName='".$name."',level='".$level."',modifytime=now(),memberBrith='".$userBirth."',memberArea='".$userArea."',memberSex='".$userSex."',memberColor='".$userColor."',memberPhone='".$userPhone."',memberEmail='".$userEmail."' where seqno='".$seq."'");	
