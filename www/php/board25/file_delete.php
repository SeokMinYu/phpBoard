<?php
	...
	$filesql = mysqli_query($connect,"select * from upload25 where seqno='".$sqn."'");
	...
	if($num_row > 0)
	{
		...
		$filesql2 = mysqli_query($connect,"delete from upload25 where seqno='".$sqn."'");
	}

	$filesql3 = mysqli_query($connect,"select * from upload25 where idx='".$bno."'");
